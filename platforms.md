...
2. **`importers.py` FreeCAD paths** — hardcoded Linux AppImage candidates;
   macOS/Windows need env override or new candidate layouts before STEP tests
   pass.
